...
struct MainWindow::Private {
    ...
    void setupActions()
    {
        ...
        actionCollection->setDefaultShortcuts(mGoToPreviousAction, {QKeySequence(Qt::Key_Left)});
        ...
        actionCollection->setDefaultShortcuts(mGoToNextAction, {QKeySequence(Qt::Key_Right)});
